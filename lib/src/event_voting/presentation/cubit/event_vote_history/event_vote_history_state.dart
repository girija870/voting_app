...
class EventVoteHistoryState with _$EventVoteHistoryState {
  ...
  const factory EventVoteHistoryState.error({required String errMessage}) =
      _Error;

  const factory EventVoteHistoryState.success(
          {required ApiResponse<List<EventHistoryResponseModel>> response}) =
      _Success;
}
