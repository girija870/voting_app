...
extension NumX on num {
  ...
  Future<dynamic> get delayedMicroSeconds async => Future.delayed(toInt().microSeconds);

  Future<dynamic> get delayedMilliSeconds async => Future.delayed(toInt().milliSeconds);
